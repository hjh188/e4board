...
class CustomerFileSerializer(serializers.LuModelSerializer):
    """
    CustomerFile Serializer
    """
    class Meta:
        model = CustomerFile
        fields = '__all__'
...
class UserImageSerializer(serializers.LuModelSerializer):
    """
    UserImage Serializer
    """
    class Meta:
        model = UserImage
        fields = '__all__'
